  ...
  return (
    <div className="relative w-full flex flex-col items-center justify-start px-7 bg-black">
      ...
      <input
        type="text"
        placeholder="EMAIL"
        className="h-12 w-full bg-[#262626] border-[2px] border-[#a8a8a8] rounded-sm text-xs text-[#afb8b8] pl-6 mt-4"
      />
      <button
        type="button"
        className="h-12 w-full bg-[#4d4d4d] text-[#cacaca] rounded-sm text-xs font-bold mt-4"
      >
        ORDER NOW
      </button>
